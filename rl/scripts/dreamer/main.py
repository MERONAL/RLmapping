...
parser.add_argument('--max-episode-length', type=int, default=512, metavar='T', help='Max episode length')
parser.add_argument(
...
parser.add_argument('--planning-horizon', type=int, default=5, metavar='H', help='Planning horizon distance')
parser.add_argument('--discount', type=float, default=0.995, metavar='H', help='Planning horizon distance')
